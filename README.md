...
XIV Gear Lab is a standalone FFXIV gear recommendation and optimisation tool. It is designed as a Windows desktop application with a shared browser-capable core. The v0.9.0-alpha.19 executable bundles Dawntrail plus preliminary Endwalker, Shadowbringers, Stormblood and Heavensward level-cap data, and retains dormant A Realm Reborn formula support for a later signed catalogue update.
...
Run `release/XIV-Gear-Lab-0.9.0-alpha.19-portable.exe`. It is an unsigned, unfinished, non-commercial preview, so Windows may show an unknown-publisher warning. It does not require installation, the game client, an FFXIV account, logs, or plugins.
...
- Current generated XIVAPI v2 candidate with 4,523 official combat-job items: 618 Dawntrail records, 540 Endwalker level-90 records, 609 preliminary Shadowbringers level-80 records, 1,731 preliminary Stormblood level-70 records and 1,025 preliminary Heavensward level-60 records, with official IDs, job eligibility, stats, caps, slots and content-addressed icons.
