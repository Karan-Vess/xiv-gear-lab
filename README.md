...
XIV Gear Lab is a standalone FFXIV gear recommendation and optimisation tool. It is designed as a Windows desktop application with a shared browser-capable core. The v0.10.0-beta.2 executable bundles level-cap data for Dawntrail, Endwalker, Shadowbringers, Stormblood, Heavensward and A Realm Reborn.
...
Run `release/XIV-Gear-Lab-0.10.0-beta.2-portable.exe`. It is an unsigned, unfinished, non-commercial preview, so Windows may show an unknown-publisher warning. It does not require installation, the game client, an FFXIV account, logs, or plugins.
